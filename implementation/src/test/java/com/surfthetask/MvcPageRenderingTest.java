...
class MvcPageRenderingTest {
    ...
    void progressPageRendersStreakHooks() throws Exception {
        mockMvc.perform(get("/progress"))
                ...
                .andExpect(content().string(not(containsString("data-prototype-screen=\"progress\""))))
                .andExpect(content().string(not(containsString("side-nav"))))
                .andExpect(content().string(not(containsString("nav-list"))))
                .andExpect(content().string(not(containsString("period-tabs"))))
    ...
    void schedulePageRendersTimetableAndInlineFormHooks() throws Exception {
        mockMvc.perform(get("/schedule"))
                ...
                .andExpect(content().string(containsString("modern-shell schedule-shell")))
                .andExpect(content().string(containsString("modern-side-nav")))
                .andExpect(content().string(not(containsString("data-prototype-screen=\"schedule\""))))
                ...
                .andExpect(content().string(containsString("value=\"SATURDAY\"")))
                .andExpect(content().string(containsString("value=\"SUNDAY\"")))
    ...
    void focusPageRendersStandaloneFocusModeHooks() throws Exception {
        mockMvc.perform(get("/focus"))
                ...
                .andExpect(content().string(containsString("modern-shell focus-shell")))
                .andExpect(content().string(containsString("modern-side-nav")))
                .andExpect(content().string(not(containsString("data-prototype-screen=\"focus\""))))
    ...
    void dailyGoalsAndTasksPagesRenderAllTaskSurfaces() throws Exception {
        mockMvc.perform(get("/daily-goals"))
                .andExpect(status().isOk())
                .andExpect(content().string(containsString("modern-shell task-archive-shell")))
                .andExpect(content().string(containsString("modern-main task-archive-main")))
    ...
    void remindersPageRendersHistoryAndPreferenceHooks() throws Exception {
        mockMvc.perform(get("/reminders"))
                ...
                .andExpect(content().string(containsString("modern-shell")))
                .andExpect(content().string(containsString("modern-side-nav")))
